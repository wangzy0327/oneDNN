...
cmake .. -DCMAKE_C_COMPILER=/root/repos/llvm-mlu/build/bin/clang -DCMAKE_CXX_COMPILER=/root/repos/llvm-mlu/build/bin/clang++ -DDNNL_CPU_RUNTIME=NONE -DDNNL_GPU_RUNTIME=DPCPP -DDNNL_GPU_VENDOR=CAMBRICON -DCMAKE_BUILD_TYPE=Debug -DDNNL_BUILD_EXAMPLES=OFF -DDNNL_BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=/root/oneDNN-mlu/

# export TBBROOT=/home/wzy/build-oneTBB
cmake .. -DCMAKE_C_COMPILER=/home/wzy/repos/llvm-mlu/build/bin/clang -DCMAKE_CXX_COMPILER=/home/wzy/repos/llvm-mlu/build/bin/clang++ -DDNNL_CPU_RUNTIME=TBB -DDNNL_GPU_RUNTIME=DPCPP -DDNNL_GPU_VENDOR=CAMBRICON -DCMAKE_BUILD_TYPE=Debug -DDNNL_BUILD_EXAMPLES=OFF -DDNNL_BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=/home/wzy/oneDNN-mlu/
make -j
make install
```