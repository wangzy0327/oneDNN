...
dnnl_status_t DNNL_API dnnl_primitive_attr_get_output_offsets(
        const_dnnl_primitive_attr_t attr, dnnl_dim_t *count, int *mask,
        const float **offsets);

dnnl_status_t DNNL_API dnnl_primitive_attr_set_output_offsets(
        dnnl_primitive_attr_t attr, dnnl_dim_t count, int mask,
        const float *offsets);
...
dnnl_status_t DNNL_API dnnl_post_ops_append_batchnormalization(dnnl_post_ops_t post_ops,
        float epsilon);
...
dnnl_status_t DNNL_API dnnl_split_desc_init(
        dnnl_split_desc_t *split_desc, const dnnl_memory_desc_t *src_md, 
        int n, int split_dim, const dnnl_memory_desc_t *dst_mds);
