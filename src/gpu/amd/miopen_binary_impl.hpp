...
struct miopen_binary_impl_base_t {
    ...
    status_t convert_alg_kind(
            alg_kind_t alg_kind, miopenTensorOp_t *hip_alg_kind) const {
        switch (alg_kind) {
            case alg_kind::binary_add:
                *hip_alg_kind = miopenTensorOp_t::miopenTensorOpAdd;
                break;
            case alg_kind::binary_mul:
                *hip_alg_kind = miopenTensorOp_t::miopenTensorOpMul;
                break;
            case alg_kind::binary_min:
                *hip_alg_kind = miopenTensorOp_t::miopenTensorOpMin;
                break;
            case alg_kind::binary_max:
                *hip_alg_kind = miopenTensorOp_t::miopenTensorOpMax;
                break;
