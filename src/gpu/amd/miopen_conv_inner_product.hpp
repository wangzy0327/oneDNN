#ifndef GPU_AMD_MIOPEN_CONV_INNER_PRODUCT_HPP
#define GPU_AMD_MIOPEN_CONV_INNER_PRODUCT_HPP
...
#include "gpu/amd/miopen_conv_inner_product_impl.hpp"
...
struct miopen_conv_inner_product_fwd_t : public miopen_inner_product_fwd_t {
    ...
    struct pd_t : public parent_pd_t {
        ...
        DECLARE_COMMON_PD_T("hip:miopen:conv", miopen_conv_inner_product_fwd_t);
        ...
        status_t init(engine_t *engine) {
            ...
            inner_product_impl_.reset(
                    new miopen_conv_inner_product_fwd_impl_t());
        ...
        status_t set_default_params() {
            ...
            // Although miopen does support arbitrary striding in the src
        ...
        bool blocking_ok(bool with_relu, bool &use_fused_path_for_blocking) const {
...
struct miopen_conv_inner_product_bwd_data_t
    ...
    struct pd_t : public parent_pd_t {
        ...
        DECLARE_COMMON_PD_T(
                "hip:miopen:conv", miopen_conv_inner_product_bwd_data_t);
        ...
        status_t init(engine_t *engine) {
            ...
            inner_product_impl_.reset(
                    new miopen_conv_inner_product_bwd_data_impl_t());
...
struct miopen_conv_inner_product_bwd_weights_t
    : public miopen_inner_product_bwd_weights_t {
    using miopen_inner_product_bwd_weights_t::miopen_inner_product_bwd_weights_t;
    using parent_pd_t = miopen_inner_product_bwd_weights_t::pd_t;
    struct pd_t : public parent_pd_t {
        using parent_pd_t::parent_pd_t;
        DECLARE_COMMON_PD_T(
                "hip:miopen:conv", miopen_conv_inner_product_bwd_weights_t);
        ...
        status_t init(engine_t *engine) {
            ...
            inner_product_impl_.reset(
                    new miopen_conv_inner_product_bwd_weights_impl_t());
