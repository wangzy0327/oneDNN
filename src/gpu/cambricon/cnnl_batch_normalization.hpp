...
#ifndef GPU_CAMBRICON_CNNL_BATCH_NORMALIZATION_HPP
#define GPU_CAMBRICON_CNNL_BATCH_NORMALIZATION_HPP
...
#include "gpu/cambricon/cnnl_batch_normalization_executor.hpp"
...
struct cnnl_batch_normalization_common_t {
...
struct cnnl_batch_normalization_fwd_t : public primitive_t {
    ...
    struct pd_t : public batch_normalization_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("bang:cnnl:any", cnnl_batch_normalization_fwd_t);
        ...
        status_t init(engine_t *) {
            ...
            if (is_training()) {
                cnnl_batch_normalization_common_t::init_ws(this, ws_md_);
            }

            if (use_global_stats()) {
                bnorm_impl_.reset(
                        new cnnl_batch_normalization_fwd_stats_impl_t());
            } else {
                bnorm_impl_.reset(new cnnl_batch_normalization_fwd_impl_t());
            }
        ...
        std::shared_ptr<cnnl_batch_normalization_impl_base_t> bnorm_impl_;
...
struct cnnl_batch_normalization_bwd_t : public primitive_t {
    using primitive_t::primitive_t;
    ...
    struct pd_t : public batch_normalization_bwd_pd_t {
        ...
        DECLARE_COMMON_PD_T("bang:cnnl:any", cnnl_batch_normalization_bwd_t);
        ...
        status_t init(engine_t *) {
            ...
            if (fuse_norm_relu()) {
                bnorm_impl_.reset(
                        new cnnl_batch_normalization_bwd_relu_impl_t());
            } else {
                bnorm_impl_.reset(new cnnl_batch_normalization_bwd_impl_t());
            }
